  ...
  def proposal
    ...
    3.times do |i|
      begin
        ...
        raw_routes_infos= RestClient.get "https://maps.googleapis.com/maps/api/directions/json?origin=#{loca.latitude},#{loca.longitude}&destination=#{loca1.latitude},#{loca1.longitude}&waypoints=optimize:true|#{loca2.latitude},#{loca2.longitude}|#{loca3.latitude},#{loca3.longitude}&key=AIzaSyB7DScGMXJIqGLyCua1lLA0RA6n3JHEd2I"
